...
public class MemberDAO extends HttpServlet {
	...
	private static final int MEMBER_EXISTENT = 1;
    ...
    public int userCheck(String id, String pw) {
    	...
    	try {
			...
			if(set.next()) {
				...
				System.out.println("login fail");
				ri = MemberDAO.MEMBER_LOGIN_IS_NOT; //ID x
			}
		} catch (Exception e) {
			e.printStackTrace();
		}finally {
	...
	private Connection getConnection() {
		...
		try {
			...
			dataSource = (DataSource)((InitialContext) context).lookup("java:comm/env/jdbc/Oracle11g");

...
<body background="img/고양이강아지.jpeg">
	...
	<hr>
	<br/>
	<table width="700" cellpadding="0" cellspacing="0" border="1" class="container" style="background-color: white;">
		<form name="reply"action="reply.do" method="post">
			...
			<input type="hidden" name="bName" value="<%= nick%>">
			<tr>
				<td>번호</td>
			...
			<tr>
				...
				<a href="list.do?page=<%= session.getAttribute("cpage")%>&table=${ctable}&search=<%= session.getAttribute("csearch")%>">목록보기</a></td>
			</tr>
		</form>
	</table>
</body>

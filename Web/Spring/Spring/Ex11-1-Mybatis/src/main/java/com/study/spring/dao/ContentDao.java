...
public class ContentDao implements IDao {
	...
	@Override
	   public ArrayList<ContentDto> listDao(){
	      String query = "select*from board order by nId desc";
	...
	@Override
	public void writeDao(final String mWriter, final String nCotnet) {
		...
		this.template.update(new PreparedStatementCreator() {
			...
			public PreparedStatement createPreparedStatement(Connection con) throws SQLException {
				String query = "insert into board(nId, mWriter, nCotnet)values (board_seq.nextval, ?, ?)";
				PreparedStatement pstmt = con.prepareStatement(query);
				pstmt.setString(1, mWriter);
				pstmt.setString(2, nCotnet);
				return pstmt;
			}
		});
	...
	public ContentDto viewDao(String strID) {
		...
		String query = "select * from board where nId = " + strID;
	...
	public void deleteDao(final String bId) {
		...
		String query = "delete from board where nId = ?";
